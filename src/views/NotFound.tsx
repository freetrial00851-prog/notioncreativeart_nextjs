  ...
  return (
    <div className="max-w-[1400px] mx-auto px-8 py-32 text-center">
      ...
      <div className="flex gap-4 justify-center text-[12px] tracking-[0.12em]">
        <Link href="/shop" className="px-7 py-3.5 bg-ink text-canvas hover:opacity-85 rounded-lg">BROWSE PATTERNS</Link>
        <Link href="/" className="px-7 py-3.5 border border-ink hover:bg-surface rounded-lg">GO TO HOMEPAGE</Link>
      </div>
    </div>
  )
}

  ...
  const body = (
    <>
      <div className="flex flex-wrap items-center gap-3 mb-6">
        <h1 className="font-display font-semibold text-3xl md:text-4xl">Order #{order.lemon_order_id || order.id.slice(0, 8)}</h1>
            ...
            <div key={item.product?.id ?? i} className="px-5 py-4 flex items-center gap-4">
              ...
              {item.product && (
                <button
                  ...
                  className="shrink-0 flex items-center gap-1.5 px-4 py-2 text-canvas text-[11px] tracking-[0.08em] font-semibold rounded-full hover:opacity-90 disabled:opacity-50"
